      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center mb-16">
          <div className="flex items-center gap-2 mb-4">
            ...
            {/* FIX 9: era h3 antes del h2 — rompía la jerarquía semántica */}
            <p className="text-zinc-500 uppercase tracking-[0.4em] text-[10px] font-black">{t('testimonials.subtitle')}</p>
          </div>
