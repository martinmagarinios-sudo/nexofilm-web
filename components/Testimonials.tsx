      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center mb-16">
          <div className="flex items-center gap-2 mb-4">
            <svg className="w-5 h-5 text-nexo-lime fill-current" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>
            <p className="text-nexo-lime uppercase tracking-[0.4em] text-[10px] font-black">{t('testimonials.subtitle')}</p>
          </div>
          <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter text-center max-w-3xl leading-[1.1]">{t('testimonials.title')}</h2>
        </div>
                ...
                >
                  <div className="glass p-8 rounded-xl flex flex-col justify-between hover:border-white/20 transition-all duration-300 group h-full">
                    <div>
                      ...
                      <p className="text-zinc-300 font-light italic mb-8 leading-relaxed text-lg">"{t(`testimonials.items.${testi.id}`)}"</p>
                    </div>
                    <a
